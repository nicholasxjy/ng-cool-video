  ...
  m.directive('ngCoolVideo', [
    ...
    function videoDirective($sce, $timeout) {
      ...
      return {
        ...
        transclude: true,
        replace: true,
        template: '<div class="ng-cool-video"><div class="ng-cool-video-container"><video></video><div class="ng-cool-video-controls"><div class="ncv-actions"><i class="fa fa-backward" ng-click="playBackward()"></i><i class="fa fa-pause" ng-click="pause()" ng-show="isPlaying"></i><i class="fa fa-play" ng-click="play()" ng-show="!isPlaying"></i><i class="fa fa-forward" ng-click="playForward()"></i></div><div class="ncv-progress"><progress class="ncv-progress-bar" max="100" value="{{progressValue}}" ng-click="skipProgress($event)"></progress></div><div class="ncv-current-time"><span class="ncv-video-duration">{{playingTime}}</span></div><div class="ncv-sound-range"><input class="ncv-volume" type="range" max="10" min="0" value="5" ng-model="video.volume"></div><div class="ncv-mute"><i class="fa fa-volume-up" ng-click="volumeOff()" ng-show="!isMuted"></i><i class="fa fa-volume-off" ng-click="volumeOn()" ng-show="isMuted"></i></div></div></div></div></div>',
        controller: ['$scope', '$element', function($scope, $element) {
          ...
          $scope.addEvents = function() {
            ...
            video.addEventListener('loadedmetadata', function() {
              ...
              //here set controls dimension too
              var _pro_width = conWidth - 120 - 60 -100 - 10;
              $progressBar.css('width', _pro_width+'px');
